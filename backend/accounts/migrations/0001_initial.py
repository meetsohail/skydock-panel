...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ssh_username', models.CharField(default='root', max_length=100)),
                ('auth_type', models.CharField(choices=[('password', 'Password'), ('private_key', 'Private Key')], default='password', max_length=20)),
                ('ssh_password', models.TextField(blank=True, null=True)),
                ('ssh_private_key', models.TextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=models.CASCADE, related_name='ssh_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
